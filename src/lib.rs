...
impl Universe {
    ...
    pub fn pulsar(&mut self, row:u32, col: u32) {
        self.set_cells(
            &[
                (row+2,col),(row+3,col),(row+4,col),
                (row+8,col),(row+9,col),(row+10,col),
                ...
                (row+8,col+5),(row+9,col+5),(row+10,col+5),

                (row+2,col+7),(row+3,col+7),(row+4,col+7),
                (row+8,col+7),(row+9,col+7),(row+10,col+7),
                ...
                (row+2,col+12),(row+3,col+12),(row+4,col+12),
                (row+8,col+12),(row+9,col+12),(row+10,col+12)
            ]
        )
    }
}
